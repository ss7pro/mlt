...
tf.app.flags.DEFINE_integer("num_threads", psutil.cpu_count(logical=False),
                            "# intra op threads")
...
tf.app.flags.DEFINE_string("output_path", settings.OUTPUT_PATH,
...
tf.app.flags.DEFINE_boolean("no_horovod", True,
